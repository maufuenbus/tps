<div class="btn-reg-ges">
    <button type="button" class="btn btn-primary " data-mdb-toggle="modal" data-mdb-target="#modif-veh">Modificar</button>
</div>

<!-- Modal Registra-->
<div class="modal fade" id="modif-veh" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
